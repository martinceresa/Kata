...
oddPlusOne (NextOdd od) = NextEven (oddPlusOne od)
...
oddPlusOdd (NextOdd od) m = NextEven (oddPlusOdd od m)
...
addZeroOdd :: Odd m -> Odd (Add m Z)
addZeroOdd OneOdd = OneOdd
addZeroOdd (NextOdd m) = NextOdd (addZeroOdd m)

-- | Proves odd * odd = odd
oddTimesOdd :: Odd n -> Odd m -> Odd (Mult n m)
oddTimesOdd OneOdd m  = addZeroOdd m
...
addZeroEven :: Even m -> Even (Add m Z)
addZeroEven ZeroEven = ZeroEven
addZeroEven (NextEven n) = NextEven $ addZeroEven n
-- | Proves odd * even = even
oddTimesEven :: Odd n -> Even m -> Even (Mult n m)
oddTimesEven OneOdd m = addZeroEven m
